...
namespace utils {
   ...
   */
  struct HBPara2c {
    double maxdist, maxdist2, minangle, min_z,max_z,radius2; // added radius a min_z and max_z
  }; //end struct HBPara2c
  ...
  class HB2c_calc : public HB_calc {
    ...
    int numHb, maxindex;
    std::ofstream timeseriesHB, timeseriesHBtot, loadsHbondsStat;
  ...
  public:
    ...
    void calc2();
    /**
     * Method that loops over all atoms from DonorA and DonorB inside a (0 0 0) centered cylindrical pore.
     * aligned in the z axis
     */
    void calc2_pore(); // added by JAG
    /**
    ...
    /**
     * Method that prints out all 2-centered H-bonds inside a (0 0 0) centered cylindrical pore
     * aligned in the z axis.
     */
    void printstatistics_pore(vector<int> loads_in_time);
