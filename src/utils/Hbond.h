...
namespace utils {
  ...
  class HB {
    ...
    HBPara2c hbpara2c;
    HBPara3c hbpara3c;
    bool do3c, do_native, do_pore; // added by jag
  public:
    /**
    ...
    void printstatistics();
     ...
     /**
     * Method that prints out all information about the H-bonds inside a  (0 0 0 ) pore
    ...
    static HBPara2c mk_hb2c_paras_pore(const vector<double> &hbparas); // added by JAG
